...
<div class="space-y-6 mt-8">
    ...
    <div class="relative flex items-start px-0 sm:px-2">
        <div class="ml-3 text-sm w-full">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                <select id="img_rights_ads" name="img_rights_ads" value="{{ old('img_rights_ads') }}" class="block w-full sm:w-auto rounded-md border-gray-700 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    <option value="" disabled selected>Elija una opción</option>
                    <option value="0">No</option>
                    <option value="1">Sí</option>
                </select>
                <p class="text-gray-500 sm:ml-2 text-justify">
    ...
    <div class="relative flex items-start px-0 sm:px-2">
        ...
        <div class="ml-3 text-sm w-full">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                <select id="img_rights_web" name="img_rights_web" value="{{ old('img_rights_web') }}" class="block w-full sm:w-auto rounded-md border-gray-700 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    <option value="" disabled selected>Elija una opción</option>
                    <option value="0">No</option>
                    <option value="1">Sí</option>
                </select>
                <p class="text-gray-500 sm:ml-2 text-justify">Envío por DISTRIBUCIONES EUROCOS, S.L.U. de comunicaciones posteriores al Evento
    ...
    <div class="relative flex items-start px-0 sm:px-2">
        ...
        <div class="ml-3 text-sm w-full">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                <select id="img_rights_rss" name="img_rights_rss" value="{{ old('img_rights_rss') }}" class="block w-full sm:w-auto rounded-md border-gray-700 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                    <option value="" disabled selected>Elija una opción</option>
                    <option value="0">No</option>
                    <option value="1">Sí</option>
                </select>
                <p class="text-gray-500 sm:ml-2 text-justify">Captar y publicar su imagen / voz durante el Evento con fines de comunicación y
    ...
    <div class="relative flex items-start px-0 sm:px-2">
        ...
        <div class="ml-3 text-sm w-full">
            <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                <select id="privacy_policy" name="privacy_policy" value="{{ old('privacy_policy') }}" class="block w-full sm:w-auto rounded-md border-gray-700 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
                    <option value="" disabled selected>Elija una opción</option>
                    <option value="0">No</option>
                    <option value="1">Sí</option>
                </select>
...
<div class="text-sm text-justify mb-4 flex items-start p-0 sm:p-2">
