...
<head>
    ...
    <title>Tu entrada — {{ $edition->event->name }}</title>
</head>
                ...
                <tr>
                    <td style="padding:40px 48px 0;">
                        ...
                        <p style="color:#64748b; font-size:15px; line-height:1.7; margin:0 0 32px;">
                            Tu inscripción ha sido registrada correctamente. A continuación encontrarás
                            los detalles de tu entrada. Guarda el código QR y preséntalo en el acceso al evento.
                        </p>
                    </td>
                </tr>
                            ...
                            <tr>
                                <td style="padding:0 20px;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="padding:16px 0; border-bottom:1px solid #f1f5f9;">
                                                <span style="color:#94a3b8; font-size:11px; text-transform:uppercase; letter-spacing:1px; font-weight:600;">Edición</span>
                                            </td>
                                            <td style="padding:16px 0; border-bottom:1px solid #f1f5f9;">
                                                <span style="color:#0f172a; font-size:15px; font-weight:600;">#{{ $edition->id }}</span>
                                            </td>
                                        </tr>
                ...
                <tr>
                    <td style="padding:0 48px 32px;">
                        <p style="color:#94a3b8; font-size:12px; line-height:1.7; margin:0;">
                            Si no solicitaste esta inscripción o crees que has recibido este correo por error, puedes ignorarlo con seguridad.
                        </p>
                    </td>
                </tr>
