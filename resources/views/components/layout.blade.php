    ...
    <div class="grow">
      <nav class="bg-teal-800" x-data="{ open: false }">
          ...
          <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:flex items-center space-x-2">
              @auth
                ...
                @endif
                <x-nav_link href="{{ route('account-password-edit') }}" :active="request()->routeIs('account-password-edit')" title="Cambiar contraseña">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div x-show="open" @click.outside="open = false" class="md:hidden bg-teal-900 px-4 pb-4 space-y-1">
          ...
          @endadmin
          @auth
            <a href="{{ route('account-password-edit') }}" class="block text-white hover:bg-teal-700 px-3 py-2 rounded-md text-base font-medium">Cambiar contraseña</a>
